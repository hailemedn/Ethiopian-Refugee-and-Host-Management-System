	...
	<?php include('navbar.php'); ?>
			<div id="masthead">  
				...
				<div class="container">
					<div class="row">
					<div class="col-md-12">
						<div class="top-spacer"> <h2 style="Color:black;">Hosts looking to provide a home</h2></div>
                        <div class="top-spacer">
                            <form class="form-inline" method="post" action="host-search.php">
...
<div class="container">
  <div class="row">
	...
	$query = $conn->query("select  * from members where status LIKE 'Host' or status  LIKE 'host' and member_id = $session_id");
