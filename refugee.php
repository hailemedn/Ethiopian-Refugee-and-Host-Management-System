				...
				<div class="container">
					...
					<div class="col-md-12">
                        ...
                        <form class="form-inline" method="post" action="refugee-search.php">
                            ...
                            <!-- <input type="text" name="htsearch" class="form-control" id="span5" placeholder="search by Hometown">
                            <input type="number" name="capsearch" class="form-control" id="span5" placeholder="Capacity">
                            <input type="submit"> -->
                        </form>
...
<div class="container">
  <div class="row">
	...
	$query = $conn->query("select  * from members where status LIKE 'Refugee' or status  LIKE 'refugee' and member_id = $session_id");
	...
	?>
            ...
            <a href="friends_profile.php?id=<?php echo $friend_id;?>">        <img  src="<?php echo $posted_image; ?>" style="height:100px" class="img-circle"></a>
            </div>
		...
		<?php $query1 = $conn->query("select * from friends where my_friend_id = '$friend_id'");
			  ...
			  if ($count1 > 0){ echo 'Already Connected'; }else{
		?>	
