...
<div class="container">
  <div class="row">
	...
	$query = $conn->query("select  * from members where firstname LIKE '%$search%' OR lastname LIKE '%$search%' AND status LIKE 'Host' OR region LIKE '%$search%' OR capacity <= '$search'");
