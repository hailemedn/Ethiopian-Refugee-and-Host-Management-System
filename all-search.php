	...
	<?php include('navbar.php'); ?>
			...
			<div id="masthead">  
				...
				<div class="container">
					<div class="row">
					<div class="col-md-12">
						<div class="top-spacer"> <h2 style="Color:black;">All</h2></div>
...
<div class="container">
  <div class="row">
	...
	$query = $conn->query("select  * from members where capacity <= '$search' OR firstname LIKE '%$search%' OR lastname LIKE '%$search%' OR region LIKE '%$search%'");
