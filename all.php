	...
	<?php include('navbar.php'); ?>
			<div id="masthead">  
				...
				<div class="container">
					<div class="row">
					<div class="col-md-12">
						<div class="top-spacer"> <h2 style="Color:black;">All Users</h2></div>
                        <div class="top-spacer">
                            <form class="form-inline" method="post" action="all-search.php">
...
<div class="container">
  <div class="row">
	...
	$query = $conn->query("select  * from members where NOT member_id = $session_id");
